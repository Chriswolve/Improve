    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                ...
                if(mActiveImage.getTag().equals("0") ){
                    mActiveImage.setTag("1");
                    mActiveImage.setImageResource(R.drawable.ic_check_white_24dp);
                    credit += 20;
                }
                else{

                    mActiveImage.setTag("0");
                    mActiveImage.setImageResource(R.drawable.ic_x2_white_24dp);
                    credit -= 20;

                }
                creditos.setText("Creditos : "+credit);
                //creditos.setText("Creditos :"+credit);
                //creditos.setText("Creditos :"+ credit);
